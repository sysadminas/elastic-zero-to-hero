...
- Digite o comando para instalar o wget: `sudo yum install wget`
- Digite o comando para instalar o vim: `sudo yum install vim`
- Digite o comando para parar o firewall `sudo systemctl stop firewalld`
